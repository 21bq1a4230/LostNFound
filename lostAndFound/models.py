...
class LostItems(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, upload_to='lostitems/')
    description = models.CharField(max_length=500, default=None)

    # def __str__(self):
    #     return f"{self.submissionID}"
class FoundItems(models.Model):
    submissionID = FoundIDField()
    name = models.CharField(max_length=200, default=None)
    email = models.EmailField(default=None)
    contact = models.IntegerField(default=None)
    itemName = models.CharField(max_length=200, default=None)
    ...
    time = models.CharField(max_length=200, default=None)
    date = models.CharField(max_length=200, default=None)
    image = models.ImageField(null=True, blank=True, upload_to='founditems/')
    description = models.CharField(max_length=500, default=None)
